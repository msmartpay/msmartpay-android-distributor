...
public class ItemAdapter extends BaseAdapter {
    ...
    Context mcontext;
    ArrayList<ItemManagementModel> menuDetails;

    public ItemAdapter(Context mcontext, ArrayList<ItemManagementModel> menuDetails) {
...
//        img.setVisibility(View.GONE);
        String cimage=menuDetails.get(position).getItemImage();
        ...
        title.setText(menuDetails.get(position).getName());
        desc.setTextColor(mcontext.getResources().getColor( msmartds.in.R.color.colorPrimary));
        desc.setText(menuDetails.get(position).getLongDesc());
